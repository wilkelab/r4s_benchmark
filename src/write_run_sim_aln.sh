	...
	do	 
		...
		do
			...
			do
				...
				echo "python ../../../home1/02159/ds29583/r4s_benchmark/src/simulate_mech_codon_aln.py $bias ./r4s_benchmark_data/trees/${tree} ./r4s_benchmark_data/aln/mech_codon/nuc/${aln} ../../../home1/02159/ds29583/mech_codon/sim_rates/assigned_rates/raw_rates/${sim_rates} ../../../home1/02159/ds29583/mech_codon/sim_rates/assigned_rates/raw_rates/${sim_rates_info} ../../../home1/02159/ds29583/r4s_benchmark/mech_codon/sim_rates/true_rates/${true_rates}"  >> ./src/run_sim_aln.sh
			done
		done
	done
done
