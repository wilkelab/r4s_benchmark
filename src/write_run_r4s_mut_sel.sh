...
do	
	rm ../../../home1/02159/ds29583/run_bl${br_len}_r4s_mut_sel.sh
done
...
do	 
	...
	do	 
		...
		do
			...
			do
			echo "../../../home1/02159/ds29583/r4s_benchmark/src/r4s_pipeline.sh $bias $br_len $i $j $model" >> ../../../home1/02159/ds29583/run_bl${br_len}_r4s_mut_sel.sh
			done
		done
	chmod +x ../../../home1/02159/ds29583/run_bl${br_len}_r4s_mut_sel.sh
	done
done
